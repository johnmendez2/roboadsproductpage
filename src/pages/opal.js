    ...
    return (
        <div>
            ...
            <div className="headersection">
                ...
                <img src="https://faceaqses.s3.amazonaws.com/roboads_website/opalRobot.jpg" alt="OPAL Robot" style={{ width: '25%' }} />
            ...
            <div class="specifications-section">
                <div class="image-container">
                    <img src="https://faceaqses.s3.amazonaws.com/roboads_website/opalRobot-min.png" alt="Car" class="robot-image" />
                </div>
                <div
                    className={`specifications-container ${shouldAnimate ? "animate" : ""
                        }`}
                >    <h3 class="specifications-title"><span style={{color: '#58D7FF', fontWeight: '300'}}>OPAL</span> SPECIFICATIONS</h3>
                    <div class="specifications-list">
                        ...
                        <div class="specification">
                            ...
                            <div class="specification-value">70 KG</div>
                        </div>
                        <div class="specification">
