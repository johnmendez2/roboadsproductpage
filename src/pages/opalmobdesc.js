    ...
    return(
        <div>
            ...
            <div className="text-section" style={{marginLeft: '0px', padding: '15px'}}>
                    ...
                    <p className='futurepara' style={{fontSize:'1.3rem', width: '100%'}}><span style={{fontWeight: '900'}}>OPAL</span> mobile robots are one of the most powerful tools on the digital signage advertising scene. With a unique ability to attract attention and interact with targeted audiences, they empower brands, shape customer engagement and lead to action.</p>
                </div>
                        </div>
            ...
            <div className="text-section" style={{marginLeft: '0px', padding: '15px'}}>
                    ...
                    <p className='futurepara' style={{fontSize:'1.3rem', width: '100%'}}><span style={{ fontWeight: '900'}}>OPAL</span> can be used at corporate events, conferences, malls, product launches, crowded public places and trade shows. Moving around fully autonomously, the mobile robots engage with the right targets at the right time to deliver the right messages.</p>
                </div>
                        </div>
